/**
 * Maps OpenAlice provider key names to OpenTypeBB credential field names.
 *
 * OpenAlice config (opentypebb.json): { "fred": "abc123" }
 * OpenTypeBB expects:                 { "fred_api_key": "abc123" }
 */
