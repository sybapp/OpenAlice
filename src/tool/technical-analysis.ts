...
import { MAX_PROFILE_BINS } from '@/domain/analysis/technical-analysis/order-flow/delta-volume.js'
...
const technicalAnalysisInputSchema = z.object({
  ...
  numBins: z.number().int().positive().max(MAX_PROFILE_BINS).optional()
    .describe(`Volume Profile bin count (default 20, max ${MAX_PROFILE_BINS})`),
