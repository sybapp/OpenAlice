...
import { tool } from 'ai'
import { z } from 'zod'
import type { SymbolIndex } from '@/integrations/opentypebb/equity/SymbolIndex'
import type { CryptoClientLike, CurrencyClientLike } from '@/integrations/opentypebb/sdk/types'
