...
import { createTraderRoutes } from './trader.js'

vi.mock('../../../task/trader/index.js', () => ({
...
describe('createTraderRoutes', () => {
  it('lists strategies', async () => {
    const app = createTraderRoutes(makeCtx())
  ...
  it('creates a trader job', async () => {
    const ctx = makeCtx()
    const app = createTraderRoutes(ctx)
