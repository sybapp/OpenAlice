...
const DEFAULT_SKILL_TEMPLATES: Array<{ dirName: string; content: string }> = [
  {
    ...
    content: buildSkillTemplate({
      ...
      preferredTools: ['brooksPaAnalyze', 'brooksPa*', 'market-search*', 'equity*'],
      toolAllow: ['brooksPaAnalyze', 'brooksPa*', 'market-search*', 'equity*'],
  ...
  },
  {
    ...
    content: buildSkillTemplate({
      ...
      preferredTools: ['ictSmcAnalyze', 'ictSmc*', 'market-search*'],
      toolAllow: ['ictSmcAnalyze', 'ictSmc*', 'market-search*'],
      toolDeny: ['trading*', 'cronAdd', 'cronUpdate', 'cronRemove', 'cronRunNow'],
      outputSchema: ANALYSIS_REPORT_NAME,
  ...
  },
  {
    ...
    content: buildSkillTemplate({
      ...
      preferredTools: ['brooksPaAnalyze', 'ictSmcAnalyze', 'brooksPa*', 'ictSmc*', 'market-search*', 'equity*'],
      toolAllow: ['brooksPaAnalyze', 'ictSmcAnalyze', 'brooksPa*', 'ictSmc*', 'market-search*', 'equity*'],
      toolDeny: ['trading*', 'cronAdd', 'cronUpdate', 'cronRemove', 'cronRunNow'],
      outputSchema: ANALYSIS_REPORT_NAME,
