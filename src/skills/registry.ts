...
const DEFAULT_SKILL_TEMPLATES: Array<{ dirName: string; content: string; resources?: Record<string, string> }> = [
  ...
  },
  {
    ...
    content: buildScriptSkillTemplate({
      ...
      instructions: [
        'Request only the scripts you need. Use company news for symbol-specific questions and world news for macro context.',
  ...
  },
  {
    ...
    content: buildScriptSkillTemplate({
      ...
      stage: 'market-scan',
      scripts: ['trader-account-state', 'analysis-brooks', 'analysis-ict-smc', 'research-news-company', 'research-news-world'],
      userInvocable: false,
  ...
  },
  {
    ...
    content: buildScriptSkillTemplate({
      ...
      stage: 'trade-thesis',
      scripts: ['trader-account-state', 'analysis-brooks', 'analysis-ict-smc', 'analysis-indicator', 'research-news-company', 'research-news-world'],
      userInvocable: false,
