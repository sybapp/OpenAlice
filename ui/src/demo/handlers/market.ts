...
export const marketHandlers = [
  ...
  http.get('/api/market-data/vendors', () => HttpResponse.json({
    vendors: [
      {
        id: 'yfinance',
        name: 'yfinance',
        ...
        alwaysOn: true,
        keyless: true,
        coverage: 'Global default — US, CN, HK, TW, JP, KR, EU and more.',
        howToUse: 'Use Yahoo ticker symbols.',
      ...
      },
      {
        ...
        alwaysOn: false,
        keyless: true,
        coverage: 'CN A-shares — Shanghai and Shenzhen listed equities.',
        howToUse: 'Search by Chinese name or stock code.',
      ...
      },
      {
        ...
        howToUse: 'Use exchange-qualified symbols such as NASDAQ:AAPL, SZSE:300820, HKEX:0700, BINANCE:BTCUSDT, or FX:EURUSD; bare symbols such as AAPL are resolved through TradingView symbol search. Use this source for technical analysis only; it is not an executable quote and is never used for order submission. Bare US equities may use partial-market Cboe volume rather than SIP consolidated volume.',
      ...
      },
      {
        ...
        alwaysOn: false,
        keyless: true,
        coverage: 'Taiwan equities — TWSE listed and TPEx OTC.',
        howToUse: 'Search by traditional Chinese, English, or stock code.',
